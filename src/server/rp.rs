...
use super::transmission_channel::TransmissionChannelWorker;
...
impl RP {
    ...
    fn process_play(&self, stream: &mut TcpStream, request: RtspRequest, address: ClientInfo) {
        ...
        if let Some(worker) = &transmission_worker.worker {
            ...
            let answer = RtspResponse::new(crate::message::rtsp::Status::Ok, request.seq_number(), request.seq_number());
